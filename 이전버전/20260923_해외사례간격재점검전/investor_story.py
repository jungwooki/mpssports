...
items=[('ENGLAND','premier-league-logo.svg','Premier League','성장단계로 경기 집단 구성','비슷한 성숙도의 선수들이<br>함께 뛰는 바이오밴딩 사례'),('JAPAN / LAB','arrowz-lab-logo.svg','ARROWZ LAB','측정으로 현재 상태 이해','기초체력을 측정하고 분석해<br>개별 과제를 설명'),('JAPAN / GYM','arrowz-gym-logo.svg','ARROWZ GYM','훈련과 재측정을 연결','측정 결과를 바탕으로 훈련하고<br>기록으로 변화를 확인')]
